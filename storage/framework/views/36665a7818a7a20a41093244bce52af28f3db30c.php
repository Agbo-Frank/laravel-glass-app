...
<?php $component = $__env->getContainer()->make(App\View\Components\PageTitle::class, ['title' => 'my account','location' => 'login'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <form method="POST" class="form" action="<?php echo e(route('login')); ?>">
            ...
            <!-- Validation Errors -->
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.auth-validation-errors','data' => ['errors' => $errors]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <p>Forgot Password</p> 
            <a href="<?php echo e(route('register')); ?>" class="btn">Create An Account</a>
        </form>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\JOHNPAUL ANEKE\Laravel\first-laravel-project\resources\views/auth/login.blade.php ENDPATH**/ ?>